...
let fullNames = runners.map(function(x){
...
//let largeShirts = [];
var largeShirts = runners.filter(function(runner) {
...
const reducer = (donation, currentValue) => donation + currentValue;
   
 let  ticketPriceTotals = runners.map(function(x) {
    
      return x.donation });
    
 console.log(ticketPriceTotals.reduce(reducer));
